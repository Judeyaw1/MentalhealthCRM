...
export default function Reports() {
  ...
  const reportCards = [
    ...
    },
    {
      ...
      description: "Booking patterns, no-show rates, and session duration trends",
      icon: Calendar,
    ...
    },
    {
      ...
      description: "Progress tracking, goal completion, and therapeutic effectiveness",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: "Therapist productivity, caseload distribution, and efficiency metrics",
      icon: Activity,
    ...
    },
    {
      ...
      description: "HIPAA audit trails, documentation completeness, and regulatory compliance",
      icon: FileText,
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow cursor-pointer">
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        <div className={`p-3 rounded-lg ${report.color} transition-colors`}>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Monthly Patient Demographics Report</p>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Appointment Analytics Summary</p>
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Treatment Outcomes Report</p>
