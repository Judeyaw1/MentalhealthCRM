...
const MONGO_URI =
  process.env.MONGO_URI || "mongodb://localhost:27017/mentalhealthtracker";
...
async function main() {
  ...
  console.log(
    `Updated patients: createdBy=${result1.modifiedCount}, assignedTherapistId=${result2.modifiedCount}, inquiries.assignedTo=${result3.modifiedCount}, inquiries.createdBy=${result4.modifiedCount}`,
  );
